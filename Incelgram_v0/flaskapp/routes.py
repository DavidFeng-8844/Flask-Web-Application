...
def home():
    if request.method == 'GET':
        ...
        return render_template("home.html", title="Incelgram", get_file_url=get_file_url)
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template("new_post.html", title="Incelgram", form=form, get_file_url=get_file_url)
...
def get_post(post_id):
    ...
    return render_template("post.html", title="Incelgram", post=post, get_file_url=get_file_url)
